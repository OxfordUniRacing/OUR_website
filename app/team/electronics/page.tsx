...
export const metadata: Metadata = {
  ...
  description: 'Meet the electronics team behind Oxford University Racing.',
}

export default function ElectronicsTeamPage() {
  const teamMembers = getTeamMembersBySubteam('electronics')
    ...
    <div className="py-16 sm:py-24">
      <div className="container-custom">
        <div className="mb-12">
          ...
          <SectionTitle
            title="Electronics Team"
            subtitle="Control systems and data acquisition"
          />
        </div>
